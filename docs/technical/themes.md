...
Система тем в Lissa Health использует двухуровневую архитектуру CSS-переменных:
...
Lissa Health использует `themeProvider` из библиотеки Alt-UI для управления темами:
